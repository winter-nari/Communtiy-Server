package com.kjone.useroauth.domain.websocket.controller;
...
import com.kjone.useroauth.domain.websocket.service.UserSessionService;
...
public class WebSocketController {
    ...
    public void sendPrivateMessage(@DestinationVariable Long roomId,
